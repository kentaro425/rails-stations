class ReservationsController < ApplicationController
  ...
  def new
    ...
    render :new,
           locals: { movie_id: params[:movie_id], schedule_id: params[:schedule_id], date: params[:date],
  ...
  def create
    ...
    if @reservation.save
      ...
      redirect_to movie_reservation_path(movie_id: params[:reservation][:movie_id], schedule_id: params[:reservation][:schedule_id], date: params[:reservation][:date]),
                  alert: message
    end
  end
